...
Om det bara låter som en massa bokstäver ska jag berätta för dig att det står för **Really Simple Syndication** *(sv: Riktigt Svinenkel Syndikation)* — Syndikation i den bemärkelsen att man sänder samma media i flera olika kanaler (repostar). Den här ikonen som du kanske känner igen <Icon aria-hidden="true" class=”h-[1em] w-[1em] inline” focusable="false" name=”mdi:rss” /> signalerar ett ett rss-flöde. 
